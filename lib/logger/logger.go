...
func NewSuppressLog(level zapcore.Level, message string, fields []zap.Field, frame runtime.Frame) *SuppressLog {
	return &SuppressLog{
		Level:    level,
		Message:  message,
		Fields:   fields,
...
func (ls *LogSuppressor) Suppress(level zapcore.Level, message string, fields []zap.Field) *SuppressLog {
	const skipOffset = 2
	...
	ls.suppressLog = NewSuppressLog(level, message, fields, frame)
	return spillingLog
}
...
func (l *SuppressLogger) Error(msg string, fields ...zap.Field) {
	log := l.logSuppressor.Suppress(zap.ErrorLevel, msg, fields)
	if log == nil {
		return
	}
	l.suppressLogging(log)
...
func (l *SuppressLogger) error(log *SuppressLog) {
	fields := l.rewriteFields(log.Fields)
...
func (l *SuppressLogger) Info(msg string, fields ...zap.Field) {
	log := l.logSuppressor.Suppress(zap.InfoLevel, msg, fields)
	if log == nil {
		return
	}
	l.suppressLogging(log)
...
func (l *SuppressLogger) Warn(msg string, fields ...zap.Field) {
	log := l.logSuppressor.Suppress(zap.WarnLevel, msg, fields)
	if log == nil {
		return
	}
	l.suppressLogging(log)
...
func (l *SuppressLogger) Debug(msg string, fields ...zap.Field) {
	log := l.logSuppressor.Suppress(zap.DebugLevel, msg, fields)
	if log == nil {
		return
	}
	l.suppressLogging(log)
...
func (l *SuppressLogger) rewriteFields(fields []zap.Field) []zap.Field {
	size := len(fields)
	for i := 0; i < size; i++ {
